...
@section('content')
    <div class="container">
        ...
        {{-- Form to generate --}}
        <form id="generateQuizForm" action="{{ route('student.lessons.practice.generate', $lesson) }}" method="POST"
            class="mb-4">
            @csrf
            ...
            <div class="row">
                <div class="col-md-3">
                    ...
                    <input type="number" name="question_count" min="1" max="10" value="5"
            ...
            <button type="submit" class="btn btn-primary mt-2">Generate Practice Quiz</button>
        </form>
    ...
    <script>
        ...
        document.getElementById('checkAnswers')?.addEventListener('click', function() {
            ...
            questions.forEach((q, index) => {
                ...
                form.querySelectorAll('.option-label')[index * 4].parentElement.parentElement
                    .querySelectorAll('.option-label').forEach(label => {
